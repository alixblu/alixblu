...
% CONTACT INFORMATION
%====================
\def\name{Nguyen Thi Phuong Anh}
\def\phone{(+84) 987 092 395}
\def\city{District 3, HCMC, Vietnam}
\def\email{alixblu3011@gmail.com}
\def\LinkedIn{alixblu}
\def\github{alixblu}
\def\devpost{alixblu}
\def\role{Backend Engineer / Software Engineering Student}
\def\url{https://devpost.com/alixblu}
